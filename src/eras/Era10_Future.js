...
/**
 * Era 10 — FUTURE
 * Option B: Procedural Masterpiece (Cyber-Grid City & Dyson Rings)
 * 100% Code-based, no GLTFLoader.
 */
export class Era10_Future {
  ...
  _buildCyberPlanet() {
    ...
    // Instanced Cityscape (Glass/Neon Monoliths)
    ...
    for(let i=0; i<count; i++) {
      ...
      // Cyberpunk Neon palette (Cyan / Pink / Purple)
      const r = Math.random();
